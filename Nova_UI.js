  ...
  const handleMainSubmit = () => {
    if (mainInput.trim()) {
      const newMessage = {
        ...
        query: mainInput,
        keywords: [...keywords],
        response: "This is a sample AI response. Replace with actual API integration to get real responses from your backend.",
        timestamp: new Date()
      };
  ...
  return (
    <div className="h-screen bg-black flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex justify-between items-center pt-6 pb-6 border-b border-slate-800 px-8 flex-shrink-0">
          <button
                ...
                {messages.map((message) => (
                  <div key={message.id} className="space-y-3">
                    ...
                    <div className="flex justify-start">
                      <div className="bg-slate-800 text-white rounded-lg p-3 max-w-xs lg:max-w-md break-words">
        ...
        <div className="border-t border-slate-800 bg-black px-8 py-6 flex-shrink-0">
          <div className="max-w-5xl mx-auto">
            {/* Keywords Display */}
            {keywords.length > 0 && (
            ...
            <div className="flex gap-2 items-center">
              ...
              >
                <input
                  ...
                  className="w-full bg-slate-900 text-white px-4 py-3 rounded-lg border border-slate-700 focus:outline-none focus:border-blue-500 transition-all text-sm"
                />
              </div>
            </div>
          </div>
